...
<body>
  <div class="div1">
    <img src="logo.png"/>
      ...
      <form method="post" action="#" name="myForm22">
      <input type="text" name="search" value="" placeholder="Search Keywords..." autocomplete="off"><button type="submit" onsubmit="return validateForm22()" class="search-button"><span class="glyphicon glyphicon-search"></span></button></form><br>



    <form  action="#" method="POST" target=""> 

      <select name="classtype"><option selected="selected">Select-Class</option><option>Playway</option><option>Primary</option><option>Secondary</option><option>Higher</option></select><br>
   ...
   <!-- <button type="button" class="accordion"><i class="fa fa-map"></i>  Distance</button>
    <div class="accordion-content">
      <input type="radio" name="sortd" style="margin-bottom: 10px;" value="dctf" >  Nearest Schools<br>
    </div>-->
    <font style="font-size: 22px;font-family:arial; cursor: default;">Filter By</font>  
         <?php
$sql="select infra.sports,infra.labs,infra.arts_culture from infra";
...
?>  
    <button type="button" class="accordion"><i class='glyphicon glyphicon-education'></i>  Class</button>
    <div class="accordion-content">
       <?php
    $sql5="select distinct class from fee";
    $c5=mysqli_query($con,$sql5);
    while($row5=mysqli_fetch_assoc($c5))
    {
       $class=$row5["class"];
       if($class!="")
       echo "<li><input type='checkbox' name='class1[]' value='$class'>  ".ucwords($row5["class"])."</li>";
    }
    ?>
    </div>


     <button type="button" class="accordion"><i class='fas fa-book-open'></i>  Board</button>
    <div class="accordion-content">
       <?php
    $sql5="select distinct school_board from schools";
    $c5=mysqli_query($con,$sql5);
    while($row5=mysqli_fetch_assoc($c5))
    {
       $board=$row5["school_board"];
       if($board!="")
       echo "<li><input type='checkbox' name='board[]' value='$board'>  ".$row5["school_board"]."</li>";
    }
    ?>
    </div>
    ...
    <div class="accordion-content">
      ...
      <section class="range-slider">
        ...
        <input value="0" min="0" max="500000" step="500" type="range" name="minv">
        <input value="500000" min="0" max="500000" step="500" type="range" name="maxv">
      </section>
    </div>
...
<?php include "sort.php";?>
      ...
      <?php
         ...
         // $sql="select * from schools where school_city='$city' order by school_rating";
          ...
          <p><?php echo ucwords($row['school_address']);?></p>
